...
namespace cheat::feature
{
    ...
    ChestIndicator::ChestIndicator() : Feature(),
        NFEX(f_Enabled, u8"ÏÔÊ¾±¦Ïä", u8"ÏÔÊ¾±¦Ïä", u8"ÊÓ¾õ", false, false)
    {
    ...
    {
        static const FeatureGUIInfo info{ u8"ÏÔÊ¾±¦Ïä", u8"ÊÓ¾õ", false };
        return info;
    }

    void ChestIndicator::DrawMain()
    {
        ConfigWidget(f_Enabled, u8"ÏÔÊ¾±¦Ïä,ÓÎÏ·¼¼ÇÉ.");
    }
