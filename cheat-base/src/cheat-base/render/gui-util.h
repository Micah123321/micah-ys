...
namespace ImGui
{
	...
	bool BeginSelectableGroupPanel(const char* label, bool& value, bool& changed, bool node = false, const ImVec2& size = ImVec2(-1.0f, 0.0f), const char* selectLabel = reinterpret_cast<const char*>(u8"ȫѡ"));
